...
urlpatterns = [
    ...
    path('',views.BoardListView.as_view(),name='homepage'),
    ...
    path('settings/password/done',auth_views.PasswordChangeDoneView.as_view(template_name='password_change_done.html'),name='password_change'),
    ...
    path('board/<int:pk>/topic/<int:topics_pk>/',views.topic_posts,name='topic_posts'),
    path('board/<int:pk>/topic/<int:topics_pk>/post/<int:post_pk>/edit',views.UpdatePost.as_view(),name='update_post'),
    path('board/<int:pk>/topic/<int:topics_pk>/reply/',views.reply_topic,name='reply_topic'),
